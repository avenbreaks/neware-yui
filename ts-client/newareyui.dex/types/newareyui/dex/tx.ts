...
export const protobufPackage = "newareyui.dex";
...
function createBaseMsgCreatePool(): MsgCreatePool {
  return { creator: "", amount: undefined, desc: "", height: 0 };
}
...
function createBaseMsgUpdatePool(): MsgUpdatePool {
  return { creator: "", id: 0, amount: undefined, desc: "", height: 0 };
}
